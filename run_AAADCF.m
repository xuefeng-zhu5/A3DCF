function results = run_AAADCF(seq, res_path, bSaveImage, parameters)
% Set tracker parameters and run tracker 
%(parametes for OTB100, UAV123, DTB70, LaSOT, GOT10k and TrackingNet)
...
params.learning_rate = [0.01 0.003];          % updating rate in each learning stage
